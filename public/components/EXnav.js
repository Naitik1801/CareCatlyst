function navbar(){
    ...
    <div id="sidebar">
        ...
        <div class="dropdown">
            ...
            <div id="myDropdown" class="dropdown-content">
                ...
                <a href="#" class="app">Ngo/Charity</a>
                <a href="#" class="app">Other cases</a>
            </div>
        </div>
        <a href="./howitworks.html">How its work</a>
        <a href="https://api.whatsapp.com/send?phone=9199999-XXXXX">Get us On whatsapp</a>
    ...
    <!-- ==================== navbar========================================== -->
    <div id="nav">
        <div id="logo" onclick="home()"><img src="Images/carecatalyst-high-resolution-logo-transparent.png" alt="">
        </div>
        <div id="sec_nav">
            <a href="./BrowseFundraisers.html">Browse Fundraisers</a>
            <div class="tdropdown">
                <button onclick="mytFunction()" class="tdropbtn">Fundraiser for<i
                        class="fa-sharp fa-solid fa-caret-down"></i></button>
